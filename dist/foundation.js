...
function foundPayloadFactory(zclId) {
            ...
            switch (this.cmd) {
                ...
                case "discover":
                    if (typeof payload !== "object" || Array.isArray(payload))
                        throw new TypeError("Payload arguments of " +
                            this.cmd +
                ...
                default:
                    this.params.forEach(function (param) {
                        ...
                        if (arg[paramName] === undefined)
                            throw new Error("Payload of commnad: " +
                                self.cmd +
                                " must have " +
                                paramName +
                                " property.");
    ...
    function ensureDataTypeString(dataType) {
        if (typeof dataType === "number") {
            ...
            if (entry)
                return entry.key;
            throw new Error(`Unknown dataType number: ${dataType} (0x${dataType.toString(16)})`);
        }
